...
let rendererConfig = {
  ...
  resolve: {
    alias: {
      ...
      '@sass': path.join(__dirname, '../src/renderer/styles/sass'),
      ...
      '@filter': path.join(__dirname, '../src/renderer/filter'),
      '@config': path.join(__dirname, '../src/renderer/config'),
      '@directive': path.join(__dirname, '../src/renderer/directive'),
      '@components': path.join(__dirname, '../src/renderer/views/components')
    },
